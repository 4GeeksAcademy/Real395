    ...
    const cardImages = [
        {
            ...
            description: "Administramos los recursos económicos del edificio de manera ordenada y transparente, asegurando un adecuado control de ingresos, gastos y obligaciones.",
        ...
        },
        {
            ...
            description: "Gestionamos la comunicación del edificio de manera ordenada y oportuna, facilitando el acceso a información relevante y asegurando un adecuado control de la información.",
